...
export function googleAvailable() {
  return Boolean(import.meta.env.VITE_GOOGLE_CLIENT_ID && import.meta.env.VITE_GOOGLE_AUTH_PROXY);
}

export function signInWithGoogle(appName = 'AbhiShree Hospital') {
